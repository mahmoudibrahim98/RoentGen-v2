...
#SBATCH --output=logs/logs_v1/0_train_full_hcn_rerun/training_%j.out
#SBATCH --error=logs/logs_v1/0_train_full_hcn_rerun/training_%j.err
...
mkdir -p logs/logs_v1/0_train_full_hcn_rerun

# Config file path (adjust as needed)
CONFIG_FILE="configs/v1/0_train_full_hcn_rerun.yaml"

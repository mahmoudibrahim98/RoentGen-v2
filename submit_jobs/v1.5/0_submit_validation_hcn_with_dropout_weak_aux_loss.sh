...
#SBATCH --output=logs/logs_v1/0_train_full_hcn_rerun/validation_%j.out
#SBATCH --error=logs/logs_v1/0_train_full_hcn_rerun/validation_%j.err
...
CONFIG_FILE="${1:-configs/v1/0_train_full_hcn_rerun.yaml}"  # Use first argument or default

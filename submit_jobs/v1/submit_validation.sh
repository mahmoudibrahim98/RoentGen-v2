...
#SBATCH --output=logs/logs/0_full_hcn_rerun/validation_%j.out
#SBATCH --error=logs/logs/0_full_hcn_rerun/validation_%j.err
...
CONFIG_FILE="${1:-configs/v1/0_train_full_hcn_rerun.yaml}"

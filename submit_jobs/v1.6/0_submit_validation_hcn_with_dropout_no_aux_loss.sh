...
#SBATCH --output=logs/logs_v1.6/0_train_hcn_with_dropout_no_aux_loss/validation_%j.out
#SBATCH --error=logs/logs_v1.6/0_train_hcn_with_dropout_no_aux_loss/validation_%j.err
...
CONFIG_FILE="${1:-configs/v1.6/0_train_hcn_with_dropout_no_aux_loss.yaml}"  # Use first argument or default

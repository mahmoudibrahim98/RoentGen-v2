...
#SBATCH --output=logs/logs_v1.6/0_train_hcn_with_dropout_no_aux_loss/training_%j.out
#SBATCH --error=logs/logs_v1.6/0_train_hcn_with_dropout_no_aux_loss/training_%j.err
...
mkdir -p logs/logs_v1.6/0_train_hcn_with_dropout_no_aux_loss

# Config file path (adjust as needed)
CONFIG_FILE="configs/v1.6/0_train_hcn_with_dropout_no_aux_loss.yaml"

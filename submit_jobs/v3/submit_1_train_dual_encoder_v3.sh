...
#SBATCH --output=logs_v3/1_dual_encoder_v3/training_%j.out
#SBATCH --error=logs_v3/1_dual_encoder_v3/training_%j.err
...
mkdir -p logs_v3/1_dual_encoder_v3

# Config file path (adjust as needed)
CONFIG_FILE="configs/v3/1_train_dual_encoder_v3.yaml"

...
#SBATCH --output=logs/logs_v4/1_demographic_encoder/training_%j.out
#SBATCH --error=logs/logs_v4/1_demographic_encoder/training_%j.err
...
mkdir -p logs/logs_v4/1_demographic_encoder

# Config file path (adjust as needed)
CONFIG_FILE="configs/v4/1_train_demographic_encoder.yaml"

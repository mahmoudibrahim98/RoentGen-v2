...
#SBATCH --output=logs/logs_v4/2_demographic_encoder_full_dropout/training_%j.out
#SBATCH --error=logs/logs_v4/2_demographic_encoder_full_dropout/training_%j.err
...
mkdir -p logs/logs_v4/2_demographic_encoder_full_dropout

# Config file path (adjust as needed)
CONFIG_FILE="configs/v4/2_train_demographic_encoder_full_dropout.yaml"

...
#SBATCH --output=logs/logs_v4/2_demographic_encoder_full_dropout/validation_%j.out
#SBATCH --error=logs/logs_v4/2_demographic_encoder_full_dropout/validation_%j.err
...
CONFIG_FILE="${1:-configs/v4/2_train_demographic_encoder_full_dropout.yaml}"  # Use first argument or default

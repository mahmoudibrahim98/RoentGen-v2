...
#SBATCH --output=logs/1_baseline_debug/validation_%j.out
#SBATCH --error=logs/1_baseline_debug/validation_%j.err
...
# Optional: Check interval, manifest file, and load images flag arguments

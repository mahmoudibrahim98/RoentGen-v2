...
#SBATCH --output=logs/2_hcn_without_uncertainty/validation_%j.out
#SBATCH --error=logs/2_hcn_without_uncertainty/validation_%j.err
...
CONFIG_FILE="${1:-configs/2_hcn_without_uncertainty.yaml}"  # Use first argument or default
